      ...
      <div class="shell">
        ...
        ${
          appState.route.view === "account"
            ...
            : `
              <div class="layout ${appState.route.view === "home" ? "home-layout" : ""} ${appState.route.view === "create" ? "create-layout" : ""} ${appState.route.view === "browse" ? "browse-layout" : ""} ${appState.route.view === "communities" ? "communities-layout" : ""} ${appState.route.view === "community" ? "community-route-layout" : ""} ${appState.route.view === "project" ? "project-route-layout" : ""} ${appState.route.view === "messages" ? "messages-route-layout" : ""} ${appState.route.view === "about" || appState.route.view === "feedback" || appState.route.view === "privacy" || appState.route.view === "terms" ? "info-route-layout" : ""}">
